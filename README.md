...
A production-grade Lakeflow Spark Declarative Pipeline for processing chatbot checkpoint data generated by the LangGraph deployment project using the Medallion architecture pattern.

## Overview

This pipeline ingests, cleanses, and aggregates chatbot checkpoint events produced by the LangGraph deployment project to enable actionable user and team analytics. Built on Databricks with Unity Catalog, it implements enterprise-grade data quality, incremental processing, and change data capture patterns.

## Related Projects and Integration

This project is part of a broader chatbot analytics ecosystem.

* **LangGraph deployment**: The source data project for this pipeline, providing the chatbot checkpoint and thread lookup datasets.
